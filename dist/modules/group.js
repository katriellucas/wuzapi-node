...
//#region src/modules/group.ts
var GroupModule = class extends require_client.BaseClient {
	/**
	...
	*/
	async getInviteLink(groupJID, reset = false, options) {
		...
		return this.get(`/group/invitelink?${params}`, options);
	}
	/**
	...
	*/
	async setEphemeral(groupJID, duration, options) {
		...
		return this.post("/group/ephemeral", request, options);
	}
	/**
	* Remove group photo
	*/
	async removePhoto(groupJID, options) {
		...
		return this.post("/group/photo/remove", request, options);
	}
	/**
	* Leave a group
	*/
	...
	*/
	async setAnnounce(groupJID, announce, options) {
		...
		return this.post("/group/announce", request, options);
	}
	/**
	...
	*/
	async getInviteInfo(inviteCode, options) {
		const request = { Code: inviteCode };
		return this.post("/group/inviteinfo", request, options);
	}
	/**
	...
	*/
	async updateParticipants(groupJID, action, participants, options) {
		...
		return this.post("/group/updateparticipants", request, options);
	}
	/**
	...
	*/
	async getRequestParticipants(groupJID, options) {
		const params = `groupJID=${encodeURIComponent(groupJID)}`;
		return this.get(`/group/requestparticipants?${params}`, options);
	}
	/**
	...
	*/
	async updateRequestParticipants(groupJID, action, phones, options) {
		...
		return this.post("/group/updaterequestparticipants", request, options);
	}
	/**
	...
	*/
	async setJoinApprovalMode(groupJID, mode, options) {
		...
		return this.post("/group/joinapprovalmode", request, options);
	}
};
//#endregion
